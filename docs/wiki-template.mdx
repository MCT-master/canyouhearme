...
<WikiEntry 
    ...
    repo= ""
    // The ease section is a general summary of its use, and any problems that occured while interacting
    // Think of this as how you would explain the service to a friend and why/why not it is recomended 
    ease= ""
    // Here you can add aditional notes regarding issues with its uses, info or cautionary advice
    issues= ""
    info= ""
    caution= ""
/>