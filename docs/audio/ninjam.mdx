...
<WikiEntry 
    title= "NINJAM" 
    pic_url= "https://www.cockos.com/images/rooster.gif" 
    ...
    support_url= "https://www.cockos.com/ninjam/server-guide.php"
    ...
    issues= ""
    info= {[ "This is not a standalone application but actually a plugin for ", <a key={'link'} href='https://www.reaper.fm/'>REAPER</a> ]}
