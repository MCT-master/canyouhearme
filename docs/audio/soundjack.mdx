...
<div>
    <WikiEntry 
        title= "Soundjack"
        pic_url= {useBaseUrl('img/soundjack-logo.png')}
        ...
        issues= {[ "Please see the ", <a href="https://www.soundjack.eu/index.php/problems">FAQ</a>, " on the official site for more information." ]}
        info= ""
