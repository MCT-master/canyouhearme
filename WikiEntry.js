        ...
        return (
            <div className="rendered">
                <div className="avatar avatar--vertical">
                    { this.props.pic_url &&
                        <img className="avatar__photo avatar__photo--xl" src={this.props.pic_url}/>
                    }
                    <div className="avatar__intro">
                        <h1 className="avatar__name">{this.props.title}</h1>
                        <h4 className="avatar_links">
                ...
                values={[
                    ...
                    <TabItem value="column">
                        <div className="container">
                            <div className="row">
                                <div className="col">
                                    <h2 className="column_title">Basic information</h2>
                                ...
                                <div className="col">
                                    <h2 className="column_title">Detailed information</h2>
                    ...
                    <TabItem value="table">
                        <div className="spec-table">
                            <h2 className="spec-title">Overview of technical specifications</h2>
                            <table>
                                <tbody>
                                    <tr>
                                        <th>Detail</th>
