        ...
        steps = {[
            ...
            },
            {
                ...
                points: [
                    ...
                    "Monitoring",
                        ["When doing a stream, good monitoring is key. The most dificult thing is to separate yourself from the acoustic output of the band, since this will make it very hard to have a correct perception of what the remote audience will hear."],
                    "Microphones",
            ...
            },
            {
                title: ["That's it!"],
                points: [""],
                media: ["https://picsum.photos/400?random=3"],
