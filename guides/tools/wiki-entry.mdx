        ...
        },
        {
            ...
            points: [
                ...
                "Rename and move it to a category",
                    ...
                    "Drag the file to the category the service falls within"],
                "Fill in info for the service",
                    ...
                    "There is no set schema for each data type, but looking at the comments as well as other entries in the 'docs' folder might provide some hints."],
