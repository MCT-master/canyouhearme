    ...
    <GuideEntry 
        ...
        steps = {[
            ...
            },
            {
                ...
                descs: [
                    "Make sure that everything you can falls within the quotes (\"\") otherwise there will be issues. Links for the website and support links are automatically created, all you have to do is paste the url - no need to mess with any html.",
